...
public sealed class UmadP2ForsakenScenario : IScenario
{
    ...
    private void Run_Kefka_40004FD3()
    {
        ...
        world.Events.Add(2.46f, () => kefka_40004FD3?.Cast(ActionId.Forsaken, targetLocation: new Vector3(-0.008f, -0.015f, -0.008f), castSeconds: 6.700f, targetId: kefka_40004FD3?.GameObjectId));
        ...
        world.Events.Add(110.58f, () => kefka_40004FD3?.Cast(ActionId.LightOfJudgment, targetLocation: new Vector3(-0.008f, -0.015f, -0.008f), castSeconds: 4.700f, targetId: kefka_40004FD3?.GameObjectId));
    }
   ...
   private readonly List<SimEnemy?> towerHelper = [];
    ...
    private void Run_Kefka_40004FD0()
    {
        for (int i = 0; i < 3; i++)
        {
            SimEnemy? kefka_40004FD0 = world.SpawnEnemy(new EnemySpawnConfig(HitboxRadius: 4, BNpcBaseId: BNpcBaseId.KefkaClone, NameId: BNpcNameId.Kefka, Level: 100, Targetable: false, EnemyList: EnemyListMode.Never, IsVisible: false, Placement: new Placement(new Vector3(0.000f, 0.000f, 0.000f), 0.000f)));
